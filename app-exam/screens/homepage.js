...
import { ScrollView, View, TouchableOpacity, Image, Text, TextInput, FlatList, StyleSheet, Platform } from 'react-native';
...
const HomeScreen = ({ navigation }) => {
  ...
  return (
    ...
    <View style={styles.container}>
      ...
      <TextInput style={styles.input} placeholder="Search for flowers" />
      ...
      <FlatList
        ...
        renderItem={({ item }) => (
          <FlowerItem style={styles.flower} title={item.title}>
